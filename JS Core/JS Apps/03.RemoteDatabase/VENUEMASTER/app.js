...
const elements = {
    ...
    venues: document.querySelector("#venue-info"),
    getVenueButton: document.querySelector("#getVenues")
};

elements.getVenueButton.addEventListener('click', getVenues);
...
function getVenues() {
    ...
    elements.venues.addEventListener('click', event => {
        const currentButton = evenet.target;
